...
class mod_labelwithgroup_mod_form extends moodleform_mod {
    ...
    public function set_data($default_values)
    {
        ...
        for ($i = 1; $i <= 25; $i++) {
            ...
            $default_values = file_prepare_standard_editor($default_values, $attrname, self::EDITOROPTIONS,
                $context, 'mod_labelwithgroup', 'section', $default_values->id);
        }
    ...
    public function get_data()
    {
        ...
        for ($i = 1; $i <= 25; $i++) {
            ...
            $data = file_postupdate_standard_editor($data, $attrname, self::EDITOROPTIONS,
